...
public class My_Cart extends AppCompatActivity {
    ...
    Recyler_MyCart adapter;
    ArrayList<MyCart_pojo> arrayList= new ArrayList<MyCart_pojo>();
    String Cart_no=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mycart_item);
                ...
                if (response.equals("[]")) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < abc.length(); i = i + 2) {
                            ...
                            arrayList.add(new MyCart_pojo(data.getString("product_id"),data.getString("name")
                        ...
                        adapter = new Recyler_MyCart(arrayList, My_Cart.this, Cart_no);
