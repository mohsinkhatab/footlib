...
/**
 * Created by mohsin on 10/25/2018.
 */
...
//
        ...
        bag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CheckOut.this,MyCart.class);
                startActivity(intent);
            }
        });
...
//        zip=(EditText)findViewById(R.id.zip);
        ...
        detail.setVisibility(View.GONE);
            ...
            public void onClick(View v) {
                ...
                SharedPreferences settings = CheckOut.this.getSharedPreferences(Config.SHARED_PREF_CART, Context.MODE_PRIVATE);
...
//                    OrderDetails();
                    ...
                    e.printStackTrace();
                    Toast.makeText(CheckOut.this,"Please Check Your Email", Toast.LENGTH_LONG).show();
                    detail.setVisibility(View.VISIBLE);
                }
...
//                editor.clear();
//                editor.apply();
//        Intent intent =new Intent(CheckOut.this,My_Cart.class);
//        startActivity(intent);
