...
public class Recyler_MyCart extends RecyclerView.Adapter<Recyler_MyCart.MyViewHolder>{
    ArrayList<MyCart_pojo> arrayList = new ArrayList<>();
    Activity activity;
    String Cartid;
    String itemid;
    Float price;
    ...
    public Recyler_MyCart(ArrayList<MyCart_pojo> arrayList, Context context, String Cartid){
    ...
    public Recyler_MyCart(String product_id, String name, String replace, String item_qty, String total, String item_id, String price, String discount_price) {
    }


    @Override
    public Recyler_MyCart.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.mycart_item,parent,false);
        return new Recyler_MyCart.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(Recyler_MyCart.MyViewHolder holder, final int position) {
